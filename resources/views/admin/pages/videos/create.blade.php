      ...
      <div class="form-section">
        ...
        <div class="row g-3">
          ...
          <div class="col-md-6">
            ...
            <input class="form-control @error('language') is-invalid @enderror" name="language" type="text"
          ...
          <div class="col-md-6">
            ...
            <input class="form-control @error('duration') is-invalid @enderror" name="duration" type="number"
              value="{{ old('duration') }}" min="1" step="1" required>
          </div>
          <div class="col-md-6">
            <label>Release Date</label>
            <input class="form-control @error('release_date') is-invalid @enderror" name="release_date"
              type="date" value="{{ old('release_date') }}" required>
          </div>
          ...
          <div class="col-md-4">
            ...
            <select class="@error('age_restriction') is-invalid @enderror form-select" name="age_restriction"
              required>
          ...
          <div class="col-md-4">
            <label>Status</label>
            <select class="@error('production_status') is-invalid @enderror form-select"
              name="production_status" required>
      ...
      <div class="form-section">
        ...
        <div class="row g-3">
          <div class="col-md-12">
            ...
            <textarea class="form-control @error('imdb_description') is-invalid @enderror" name="imdb_description"
              rows="3"></textarea>
          </div>
          <div class="col-md-3">
            <label>Director</label>
            <input class="form-control @error('director') is-invalid @enderror" name="director" type="text"
              value="{{ old('director') }}" required>
          </div>
          <div class="col-md-3">
            <label>Writer</label>
            <input class="form-control @error('writer') is-invalid @enderror" name="writer" type="text"
          ...
          <div class="col-md-6">
            ...
            <select class="@error('type') is-invalid @enderror form-select" name="type" required>
          ...
          <div class="col-md-6">
            ...
            <select class="select2 @error('category') is-invalid @enderror form-select" name="category[]"
              multiple required>
          ...
          <div class="col-md-4">
            <label>Budget</label>
            <input class="form-control @error('budget') is-invalid @enderror" name="budget" type="number"
              value="{{ old('budget') }}">
          </div>
          <div class="col-md-4">
            <label>Box Office Collection</label>
            <input class="form-control @error('box_office_collection') is-invalid @enderror"
              name="box_office_collection" type="number" value="{{ old('box_office_collection') }}">
          </div>
          <div class="col-md-4">
            <label>Production Company</label>
            <input class="form-control @error('production_company') is-invalid @enderror"
              name="production_company" type="text" value="{{ old('production_company') }}">
          </div>
        </div>
      </div>
        ...
        <div class="row g-3">
          <div class="col-md-6">
            ...
            <input class="form-control @error('thumbnail') is-invalid @enderror" name="thumbnail"
              type="file" value="{{ old('thumbnail') }}" required>
          </div>
          <div class="col-md-6">
            <label>Background Poster (optional)</label>
            <input class="form-control @error('background_poster') is-invalid @enderror"
              name="background_poster" type="file" value="{{ old('background_poster') }}">
          </div>
          <div class="col-md-6">
            <label>Screenshots</label>
            <input class="form-control @error('screenshot') is-invalid @enderror" name="screenshot"
              type="file" value="{{ old('screenshot') }}" required>
          </div>
          <div class="col-md-6">
            <label>Trailer Video (optional)</label>
            <input class="form-control @error('trailer') is-invalid @enderror" name="trailer" type="file"
              value="{{ old('trailer') }}">
          </div>
          <div class="col-md-6">
            <label>Subtitle File (multiple, optional)</label>
            <input class="form-control @error('subtitle_file') is-invalid @enderror" name="subtitle_file[]"
              type="file" value="{{ old('subtitle_file') }}" multiple>
          </div>
        </div>
      </div>
        ...
        <div class="row g-3">
          ...
          <div class="col-md-6">
            ...
            <input class="form-control @error('meta_title') is-invalid @enderror" name="meta_title"
              type="text" value="{{ old('meta_title') }}" required>
          </div>
          <div class="col-md-12">
            <label>Keywords (comma separated)</label>
            <textarea class="form-control @error('keyword') is-invalid @enderror" name="keyword" rows="3"
              required></textarea>
          </div>
          <div class="col-md-12">
                ...
                <div class="row m-0 mt-4 p-0">
                  <div class="col-md-4">
                    <input class="form-control @error('download_link.0.format') is-invalid @enderror"
                      ...
                      value="{{ old('download_link.0.format') }}" placeholder="Format">
                  </div>
                  <div class="col-md-4">
                    <input class="form-control @error('download_link.0.size') is-invalid @enderror"
                      name="download_link[0][size]" type="text" value="{{ old('download_link.0.size') }}"
      ...
      $('#create-video-form').on('submit', function(e) {
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            window.location.href = response.redirect; // Redirect to the desired URL
          },
