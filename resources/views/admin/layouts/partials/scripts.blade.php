...
<script src="{{ asset('admin/iconify-icon/2.1.0/iconify-icon.min.js') }}" type="79b6a9f801a656a1193fe27a-text/javascript"></script>
...
<script src="{{ asset('admin/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js') }}"
  data-cf-settings="79b6a9f801a656a1193fe27a-|49" defer=""></script>
